...
function as_admin_sub_navigation($navigation)
{
	...
	if ($level >= AS_USER_LEVEL_ADMIN) {
        $navigation['admin'] = array( 'label' => as_lang_html('main/nav_admin') );

        $navigation['general'] = array(
        ...
        $navigation['emails'] = array(
            ...
            'icon' => 'fa fa-circle-o text-light-blue',
        );

        $navigation['users1'] = array(
