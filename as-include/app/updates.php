...
define('AS_UPDATE_CATEGORY', 'R'); // items only, category changed
define('AS_UPDATE_CLOSED', 'C'); // items only, closed or reopened
...
define('AS_UPDATE_TAGS', 'T'); // items only
...
define('AS_UPDATE_FOLLOWS', 'F'); // if a new item was posted related to one of its reviews, or for a comment that follows another
define('AS_UPDATE_C_FOR_Q', 'U'); // if comment created was on a item of the user whose stream this appears in
