...
return array(
	...
	'add_category_button' => 'Add a Category',
	'add_location_button' => 'Add A County',
	'add_towns_button' => 'Add Towns',
	'add_product_button' => 'Add a Product',
	...
	'locations_introduction' => 'To get started with counties, click the \'Add location\' button.',
	...
	'category_no_sub_error' => '^q item/s in this category have no sub-category - ^1set sub-category^2',
	'category_no_sub_to' => 'Move items in ^ with no sub-category to:',
	'category_no_subs' => 'None',
	'category_none_error' => '^q item/s currently have no category - ^1set category^2',
	'category_none_to' => 'Move items with no category to:',
	...
	'delete_category_reassign' => 'Delete this category and reassign its items to:',
	...
	'delete_hidden_note' => ' - all hidden items, review and comments without dependents',
	...
	'delete_location_reassign' => 'Delete this location and reassign its routes to:',
	...
	'hidden_articles_deleted' => 'Deleted ^1 of ^2 hidden items without dependents...',
	'hidden_title' => 'Hidden',
	'hotness_factors' => 'Relative importance for item hotness:',
	...
	'lists_title' => 'Lists',
	'locations_title' => 'Counties & Sub-Counties',
	'location_subcounties' => 'Sub-Counties',
	'location_details' => 'Google Maps details',
	'location_add_sub' => 'add sub-county',
	'location_added' => 'County added',
	'location_already_used' => 'This is already being used by a county',
	'location_default_slug' => 'county-^',
	'location_description' => 'Optional description:',
	'location_icon' => 'County Icon:',
	'location_code' => 'County Code:',
	'location_select' => 'Select a County:',
	'location_max_depth_x' => 'Some options may be hidden to prevent a county going deeper than ^ levels.',
	'location_move_parent' => 'move to different parent',
	'location_name' => 'County name:',
	'location_name_first' => 'Name:',
	'location_no_add_subs_x' => 'This county cannot have sub-county because it is already ^ levels down.',
	'location_no_delete_subs' => 'This county cannot be deleted because it has a sub-county.',
	'location_no_sub_error' => '^q item/s in this county have no sub-county - ^1set sub-county^2',
	'location_no_sub_to' => 'Move items in ^ with no sub-county to:',
	'location_no_subs' => 'None',
	'location_none_error' => '^q item/s currently have no county - ^1set county^2',
	'location_none_to' => 'Move items with no county to:',
	'location_parent' => 'Parent county:',
	'location_saved' => 'County saved',
	'product_added' => ' product added successfully',
	'product_saved' => ' product saved successfully',
	'location_slug' => 'location slug - URL fragment:',
	'location_subs' => 'Sub-counties:',
	'location_top_level' => 'No parent (top level)',
	...
	'nav_as_is_home' => 'Home (links to home page)',
	...
	'not_logged_in' => 'Please ^1signin^2 as the administrator to access this page.',
	...
	'product_name_first' => 'Name of Your First Product:',
	'product_itemcode' => 'Item Code:',
	'product_volume' => 'Volume (LENGTH	by WIDTH by HEIGHT/THICKNESS i.e 2130mm by 810mm by 42mm):',
	'product_mass' => 'Mass (FILL; FILL-MATERIAL; WEIGHT i.e Semi-Solid; Dry-wood; 17 Kgs):',
	'product_texture' => 'Texture (COLOR; TYPE/PATTEN i.e CREAM; 2):',
	...
	'aps_version' => 'AppSmata version:',
	'article_lists' => 'Item lists',
	'article_pages' => 'Item pages',
	'town_added' => 'Towns added successfully',
	'towns_saved' => 'Towns updated successfully',
	...
	'recalc_categories_recounting' => 'Recounting items for ^1 of ^2 categories...',
	...
	'recalc_posts_count' => 'Getting total number of items, reviews and comments...',
	...
	'recount_posts_note' => ' - the number of reviews, likes, flags and hotness for each post',
	'recount_posts_stop' => 'Stop recounting',
	'recount_posts_likes_recounted' => 'Recounted likes and flags for ^1 of ^2 posts...',
	...
	'refill_events_refilled' => 'Refilled for ^1 of ^2 items...',
	'registration_fields' => 'add registration fields',
	'reindex_content' => 'Reindex content',
	'reindex_content_note' => ' - for searching and related item suggestions',
	...
	'requires_aps_version' => 'Disabled - requires AppSmata ^ or later',
	...
	'tags_not_shown' => 'Some items have tags which will not be displayed.',
	...
	'total_qs' => 'Total items:',
	'total_qs_unans' => 'Total items unreviewed:',
	'unnamed_plugin' => 'Unnamed Plugin',
	'upgrade_db' => 'Your AppSmata database needs to be ^1upgraded^2 for this version.',
	...
	'users_signed up' => 'signed up users:',
	'users_title' => 'Users',
	'users_liked' => 'Users who liked:',
	'version_get_x' => 'get ^',
