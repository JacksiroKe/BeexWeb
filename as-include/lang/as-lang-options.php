...
return array(
	...
	'allow_close_articles' => 'Allow items to be manually closed:',
	'allow_close_own_articles' => 'Allow users to close their own items:',
	'allow_signin_email_only' => 'Only signin by email address (not username):',
	'allow_multi_reviews' => 'Allow multiple reviews per user:',
	'allow_no_category' => 'Allow items with no category',
	'allow_no_sub_category' => 'Allow items with a category but no sub-category',
	'allow_private_messages' => 'Enable private messaging between users:',
	'allow_self_review' => 'Allow users to review their own item:',
	'allow_user_walls' => 'Enable wall posts on user profiles:',
	'allow_view_q_bots' => 'Allow search engines to view item pages',
	...
	'caching_q_start' => 'Start caching items after:',
	'caching_q_time' => 'Cache item pages for:',
	'caching_qlist_time' => 'Cache item lists for:',
	...
	'comment_on_qs' => 'Allow comments on items:',
	...
	'default_sidebar' => 'Welcome to ^, where you can write items and receive reviews from other members of the community.',
	'default_subject' => 'A message from ^',
	'default_suffix' => 'APS',
	'default_terms' => 'I agree to the ^ Terms & Conditions and Privacy Policy',
	'do_write_check_qs' => 'Check for similar items when writeing:',
	'do_close_on_select' => 'Close items with a selected review:',
	'do_complete_tags' => 'Show matching tags while typing:',
	'do_count_q_views' => 'Count the number of item views:',
	'do_example_tags' => 'Show example tags based on item:',
	'editor_for_as' => 'Default editor for reviews:',
	'editor_for_cs' => 'Default editor for comments:',
	'editor_for_qs' => 'Default editor for items:',
	'email_privacy' => 'Privacy note for email addresses - HTML allowed:',
	'extra_field_active' => 'Custom field for extra information on write form:',
	'extra_field_display' => 'Show the extra information on item pages',
	'extra_field_display_label' => 'Show the extra information on item pages with label:',
	'feed_for_activity' => 'Feed for recent activity:',
	'feed_for_hot' => 'Feed for hot items:',
	'feed_for_as' => 'Feed for recent items and reviews:',
	'feed_for_articles' => 'Feed for recent items:',
	'feed_for_search' => 'Feeds for search results:',
	'feed_for_tag_qs' => 'Feed for each tag\'s items:',
	'feed_for_unreviewed' => 'Feed for unreviewed items:',
	...
	'follow_on_as' => 'Allow items to be related to reviews:',
	'from_email' => 'Sender address for messages from site:',
	'hot_weight_a_age' => 'Item has a new review:',
	'hot_weight_reviews' => 'Item has many reviews:',
	'hot_weight_q_age' => 'Item is new:',
	'hot_weight_views' => 'Item has many views:',
	'hot_weight_likes' => 'Item has many up likes:',
	...
	'label_amount' => 'Amount',
	'label_order' => 'Order No.',
	'label_weight' => 'Weight',
	'label_address' => 'Delivery Address',
	'label_stockin' => 'Stock IN',
	'label_stockout' => 'Stock OUT',
	...
	'match_4' => 'Wider',
	'match_5' => 'Widest',
	'match_write_check_qs' => 'Similar items matching:',
	'match_example_tags' => 'Example tags matching:',
	'match_related_qs' => 'Related items matching:',
	'max_len_q_title' => 'Maximum length of item title:',
	...
	'max_rate_user_qs' => 'Maximum items per user per hour:',
	'max_rate_user_uploads' => 'Maximum uploads per user per hour:',
	'max_rate_user_likes' => 'Maximum likes per user per hour:',
	'min_len_a_content' => 'Minimum length of review:',
	'min_len_c_content' => 'Minimum length of comment:',
	'min_len_q_content' => 'Minimum length of item body:',
	'min_len_q_title' => 'Minimum length of item title:',
	...
	'notify_admin_q_post' => 'Email this address when a item is posted',
	'notify_users_default' => 'Check email notification box by default:',
	'option_default' => 'Default',
	'page_size_activity' => 'Length of All Activity page:',
	'page_size_write_check_qs' => 'Maximum similar items to show:',
	'page_size_write_tags' => 'Maximum tag hints to show:',
	'page_size_home' => 'Length of APS page:',
	'page_size_hot_qs' => 'Length of Hot! page:',
	'page_size_pms' => 'Private messages per page:',
	'page_size_q_as' => 'Maximum reviews per page:',
	'page_size_qs' => 'Length of Items page:',
	'page_size_related_qs' => 'Maximum related items:',
	'page_size_search' => 'Search results per page:',
	'page_size_tag_qs' => 'Items on each tag page:',
	...
	'permit_all' => 'Anybody',
	'permit_approve_users' => 'Approving signed up users:',
	...
	'permit_confirmed' => 'signed up users with email confirmed',
	...
	'permit_points' => 'signed up users with enough points',
	'permit_points_confirmed' => 'signed up & email confirmed & enough points',
	'permit_see_emails' => 'Viewing user email addresses:',
	'permit_supers' => 'Super Administrators',
	'permit_users' => 'signed up users',
	...
	'points_a_liked_max_gain' => 'Limit from up likes on each review:',
	'points_a_liked_max_loss' => 'Limit from down likes on each review:',
	'points_base' => 'Add for all users:',
	'points_c_liked_max_gain' => 'Limit from up likes on each comment:',
	'points_c_liked_max_loss' => 'Limit from down likes on each comment:',
	'points_multiple' => 'Multiply all points:',
	'points_per_a_liked_down' => 'Per down like on your review:',
	'points_per_a_liked_up' => 'Per up like on your review:',
	'points_per_c_liked_down' => 'Per down like on your comment:',
	'points_per_c_liked_up' => 'Per up like on your comment:',
	'points_per_q_liked_down' => 'Per down like on your item:',
	'points_per_q_liked_up' => 'Per up like on your item:',
	'points_post_a' => 'Posting an review:',
	'points_post_q' => 'Posting a item:',
	'points_q_liked_max_gain' => 'Limit from up likes on each item:',
	'points_q_liked_max_loss' => 'Limit from down likes on each item:',
	'points_select_a' => 'Selecting an review for your item:',
	'points_like_down_a' => 'Voting down an review:',
	'points_like_down_q' => 'Voting down a item:',
	'points_like_up_a' => 'Voting up an review:',
	'points_like_up_q' => 'Voting up a item:',
	'q_urls_remove_accents' => 'Remove accents from item URLs:',
	'q_urls_title_length' => 'Item title length in URLs:',
	'recalc_hotness_q_view' => 'Recalculate hotness on every item page view:',
	...
	'show_custom_write' => 'Custom message on write form - HTML allowed:',
	...
	'show_custom_home' => 'Custom content in home page instead of APS',
	...
	'show_custom_welcome' => 'Custom message in email sent to new signed up users:',
	...
	'show_notice_welcome' => 'Notice at top for new signed up users - HTML allowed:',
	...
	'show_view_count_q_page' => 'Show view count on item pages:',
	'show_view_counts' => 'Show view count in item lists:',
	...
	'tags_or_categories' => 'Item classification:',
	'time_approved' => 'Time approved',
	'time_written' => 'Time written',
	'use_microdata' => 'Use schema.org microdata:',
	'likes_separated' => 'Show separate up and down likes:',
	'voting_on_as' => 'Allow voting on reviews:',
	'voting_on_cs' => 'Allow voting on comments:',
	'voting_on_q_page_only' => 'Allow voting on item page only:',
	'voting_on_qs' => 'Allow voting on items:',
);
