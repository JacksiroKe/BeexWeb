...
class as_joomla_default_integration
{
	...
	public static function onGetURLs()
	{
		...
		$signout = 'index.php?option=com_users&twrite=user.signout&' . JSession::getFormToken() . '=1&return=' . urlencode(base64_encode('index.php'));
	...
	/**
	 * This method would be used to write Joomla to supply an avatar for a user.
