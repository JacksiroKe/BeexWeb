...
foreach ($optionnames as $optionname) {
	...
	switch ($optionname) {
		...
		case 'points_per_c_liked_up':
		case 'points_q_liked_max_gain':
		case 'points_a_liked_max_gain':
		case 'points_c_liked_max_gain':
			$prefix = '+';
			break;

		case 'points_per_q_liked_down':
		case 'points_per_a_liked_down':
		case 'points_per_c_liked_down':
		case 'points_q_liked_max_loss':
		case 'points_a_liked_max_loss':
		case 'points_c_liked_max_loss':
			$prefix = '&ndash;';
			break;
...
as_array_insert($as_content['form']['fields'], 'points_per_c_liked_up', array('blank1' => array('type' => 'blank')));
as_array_insert($as_content['form']['fields'], 'points_like_up_q', array('blank2' => array('type' => 'blank')));
