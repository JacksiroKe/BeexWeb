...
$pcount = (int)as_opt('cache_pcount');
$pcount_anon = as_db_count_posts('P', false);
$pcount_unans = (int)as_opt('cache_unapcount');

$rcount = (int)as_opt('cache_rcount');
$rcount_anon = as_db_count_posts('R', false);
...
$as_content['form'] = array(
	...
	'fields' => array(
		...
		'pcount' => array(
			...
			'value' => as_html(as_format_number($pcount)),
		),

		'pcount_unans' => array(
			'label' => as_lang_html('admin/total_qs_unans'),
			'value' => as_html(as_format_number($pcount_unans)),
		),

		'pcount_users' => array(
			'label' => as_lang_html('admin/from_users'),
			'value' => as_html(as_format_number($pcount - $pcount_anon)),
		),

		'pcount_anon' => array(
			'label' => as_lang_html('admin/from_anon'),
			'value' => as_html(as_format_number($pcount_anon)),
		),
		...
		'rcount' => array(
			...
			'value' => as_html(as_format_number($rcount)),
		),

		'rcount_users' => array(
			'label' => as_lang_html('admin/from_users'),
			'value' => as_html(as_format_number($rcount - $rcount_anon)),
		),

		'rcount_anon' => array(
			'label' => as_lang_html('admin/from_anon'),
			'value' => as_html(as_format_number($rcount_anon)),
		),
		...
		'users_liked' => array(
			'label' => as_lang_html('admin/users_liked'),
			'value' => as_html(as_format_number(as_db_count_active_users('userlikes'))),
		),
	),
);
