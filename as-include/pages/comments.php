...
/*
	...
	Description: Controller for page listing recent comments on items
...
// Get list of comments with related items, plus category information
...
return as_p_list_page_content(
	as_any_sort_and_dedupe($items), // items
