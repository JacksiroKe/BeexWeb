...
/*
	...
	example, it could include the activity on a particular item, or the activity by a particular user.
...
function as_db_favorite_create($userid, $entitytype, $entityid)
{
	...
	if ($useshared) {
		...
		as_db_query_sub(
			...
			'SELECT #, entitytype, entityid, articleid, lastpostid, updatetype, lastuserid, updated FROM ' .
