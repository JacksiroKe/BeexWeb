...
$maximaDefaults = array(
	...
	// Keep event streams trimmed - not worth storing too many events per item because we only display the
	// most recent event for each item, that has not been invalidated due to hiding/unselection/etc...
