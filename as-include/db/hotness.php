...
/*
	...
	Description: Functions for dealing with item hotness in the database
...
function as_db_hotness_update($firstpostid, $lastpostid = null, $viewincrement = false)
{
	...
	$arguments = array(
		...
		as_opt('hot_weight_likes') * 160000,
