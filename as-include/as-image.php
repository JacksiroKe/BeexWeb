	...
	if (isset($blob)) {
		...
		if (isset($content)) {
			...
			if (strlen($content) && ($size > 0)) {
				...
				$cachesizes = as_get_options(array('avatar_profile_size', 'avatar_users_size', 'avatar_q_page_q_size', 'avatar_q_page_a_size', 'avatar_q_page_c_size', 'avatar_p_list_size'));
