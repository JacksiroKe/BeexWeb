...
class SMTP
{
     ...
     * @param string $authtype The auth type (PLAIN, signin, NTLM, CRAM-MD5, XOAUTH2)
    ...
    public function authenticate(
        ...
        if (array_key_exists('EHLO', $this->server_caps)) {
            ...
            if (empty($authtype)) {
                foreach (array('CRAM-MD5', 'signin', 'PLAIN', 'NTLM', 'XOAUTH2') as $method) {
        ...
        switch ($authtype) {
            ...
            case 'signin':
                // Start authentication
                if (!$this->sendCommand('AUTH', 'AUTH signin', 334)) {
                    return false;
                }
