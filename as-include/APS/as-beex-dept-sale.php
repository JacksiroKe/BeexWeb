...
*/
class BxSalesDept extends BxDepartment
{
    ...
    */
    ...
    public function create_department()
    {
        ...
        if (empty($this->depttype)) $this->depttype = "SALE";
        if (empty($this->icon)) $this->icon = "department.jpg";
        if (empty($this->title)) $this->title = "Sales and Marketing";
        if (empty($this->content)) $this->content = "This is the Sales and Marketing Management Department.";
