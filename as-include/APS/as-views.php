<?php
  ...
  function as_product_dialog($product)
  {
    ...
    return htmLawed($html, array('tidy'=>'  '));
  }
  ...
  function as_stock_add_form($product, $showcancel = true) 
  {
    ...
    $html .= '<input type="hidden" id="stock_'.$product['postid'].'" value="'.$product['postid'].'">';

    $html .= '<div class="form-group">
      <label class="col-sm-3 control-label">Quantity</label>
      <div class="col-sm-9">
      <input type="number" placeholder="1" min="1" class="form-control" id="qty_'.$product['postid'].'" required>
      </div>
      </div>';
    ...
    $html .= '<div class="row">
      ...
      <select class="form-control" id="state_'.$product['postid'].'" required>
    ...
    $html .= '<br>
      ...
      <input type="number" placeholder="1" min="1" class="form-control" id="bprice_'.$product['postid'].'" required>
      </div>
      </div>
      <div class="col-lg-6">
      <div class="input-group">
      <label>Selling Price</label>
      <input type="number" placeholder="1" min="1" class="form-control" id="sprice_'.$product['postid'].'" required>
      </div>
      </div>
      </div>';
