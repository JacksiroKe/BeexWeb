...
*/
class BxHumanResource extends BxDepartment
{
    ...
    */
    ...
    public function create_new()
    {
        ...
        if (empty($this->depttype)) $this->depttype = "HR";
        if (empty($this->icon)) $this->icon = "department.jpg";
        if (empty($this->title)) $this->title = "Human Resource";
        if (empty($this->content)) $this->content = "This is the Human Resource Management Department.";
