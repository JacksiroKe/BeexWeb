...
* [Severity: minor] Fixed the `target="_blank"` vulnerability reported by James Gwriteell.
...
* [#11177](https://dev.ckeditor.com/ticket/11177): Widget drag handler improvements:
  ...
  * [#11281](https://dev.ckeditor.com/ticket/11281): Fixed: Drag handler and mwrite are duplicated after widget reinitialization.
